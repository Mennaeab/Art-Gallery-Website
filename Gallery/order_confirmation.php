...
if (isset($_SESSION['order_number'])) {
    $order_number = $_SESSION['order_number']; // Retrieve the order number from the session
} else {
    // Redirect to a different page or display an error message if the order number is not set
    header("Location: home.php"); // Redirect to the main page if the order number is not available
    exit;
}
?>
<!DOCTYPE html>
...
<main>
    <section class="contact-submit">
        <p>Thank you for your inquiry! Your confirmation number is: <?php echo "#" , $order_number; ?></p>
